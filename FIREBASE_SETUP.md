...
The configured administrator email is `kybanichbek1488@gmail.com`. Create this Firebase Authentication user and sign in with the full email address on the site.
